...
var vm = new Vue({
  ...
  data: {
    // banner图片
    banners: [
      "/learn-project/html/webPortal/img/pic1.jpg",
      "/learn-project/html/webPortal/img/pic2.jpg",
      "/learn-project/html/webPortal/img/pic3.jpg",
      "/learn-project/html/webPortal/img/pic4.jpg",
    ],
    // 标签项数据
    labels: [
      {
    ...
    infoList: [
      {
        ...
        pic: "/learn-project/html/webPortal/img/visa4.jpg",
        promotTexts: [
          "OCR黑科技只能识别",
          "基础资料一键搞定，省时省事",
          "手机扫描自动填写身份证信息",
      ...
      },
      {
        ...
        pic: "/learn-project/html/webPortal/img/visa2.jpg",
        promotTexts: [
          "OCR黑科技只能识别",
          "基础资料一键搞定，省时省事",
          "手机扫描自动填写身份证信息",
      ...
      },
      {
        ...
        pic: "/learn-project/html/webPortal/img/visa3.jpg",
        promotTexts: [
          "自动检测是否佩戴不合格饰品",
          "智能检测光线是否有阴阳脸",
          "智能提示照片是否符合要求",
    ...
    codePicUrl: "/learn-project/html/webPortal/img/visa1.jpg",
    sumCount: null,
    aniTime: 0,
    curIndex: 0,
    duration: 500,
